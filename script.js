    ...
    fields.forEach(function (field) {
      ...
      if (field.hasAttribute('required') && value === '') {
        ...
        if (value.length < minLength) {
          errorMessage = formatFieldName(fieldName) + ' must be at least ' + minLength + ' characters.';
        }
      } else if (field.hasAttribute('maxlength')) {
        const maxLength = parseInt(field.getAttribute('maxlength'), 10);
        if (value.length > maxLength) {
          errorMessage = formatFieldName(fieldName) + ' must not exceed ' + maxLength + ' characters.';
        }
      }
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '21116e28-2fe9-41da-a09f-eba904530142',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '21116e28-2fe9-41da-a09f-eba904530142';
            ...
            if (mobileToggle && navMenu) {
                ...
                if (phoneHeaderBtn) {
                    phoneHeaderBtn.addEventListener('click', function() {
                        ...
                        // Falls back to 0535250604 placeholder which businessInfoUpdater can replace
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '21116e28-2fe9-41da-a09f-eba904530142';
